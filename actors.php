<?php
    ...
    $sql = "SELECT COUNT(actor_id) FROM actor";
    ...
    $sql = "SELECT * FROM actor ORDER BY last_name ASC LIMIT {$limit} OFFSET {$offset}";
            ...
            <tbody class="table-group-divider">
                <?php foreach ($rows as $row): ?>
                    <tr>
                        ...
                        <td><?= $row["last_name"] ?></td>
                        <td>
                            <a class="btn btn-primary" href="edit_actor.php?actor_id=<?= $row["actor_id"] ?>">edit</a>
                            <a class="btn btn-danger" href="delete_actor.php?actor_id=<?= $row["actor_id"] ?>">delete</a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
